#############################################################################################################################################################
## This script trains the GPz machine learning with the match from DES DR2 X VIPERS #########################################################################
#############################################################################################################################################################
...
def main(DR2_folder, VIPERS_catalog, train_size, test_size, number_sim, method, maxIter, maxAttempts, m,
 binWidth, outpath):
    ...
    X = data[['MAG_AUTO_G_DERED', 'MAG_AUTO_R_DERED', 'MAG_AUTO_I_DERED', 'MAG_AUTO_Z_DERED', 'MAG_AUTO_
Y_DERED']].values
    Y = data["z"].values.reshape(-1, 1)
    err = data[["MAGERR_AUTO_G", "MAGERR_AUTO_R", "MAGERR_AUTO_I", "MAGERR_AUTO_Z", "MAGERR_AUTO_Y"]].va
lues
